...
| CROSSPLAY_JOIN_CODE_NOTIFICATIONS | `0`               | FALSE    | Optional, if you have a webhook url supplied and turn this to one. It will post crossplay join codes when they are generated on the server.                                                                                                                                                                                  |
